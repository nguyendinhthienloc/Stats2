...
training. The shared fold IDs are reused by every model [@Hastie2009].

\tightinputtable{../output/tables/tab_p1_split_summary.tex}

## Outliers and transformations

Tukey's 1.5-IQR rule [@Tukey1977] flags `r analysis_summary$rows_with_any_iqr_flag` training
