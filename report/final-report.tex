...
\hypersetup{
  ...
  pdfauthor={Tran Le Anh Tuan (24125107); Nguyễn Bảo Minh Triết (24125047); Nguyễn Đình Thiên Lộc (24125093); Nguyễn Hồng Tấn Tài (24125078); Lê Minh Thuận (24125105)},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{STAT452 Final Project: Wine Quality and Experimental Design}
\author{Tran Le Anh Tuan (24125107) \and Nguyen Bao Minh Triet
(24125047) \and Nguyen Dinh Thien Loc (24125093) \and Nguyen Hong Tan Tai (24125078) \and Le Minh Thuan (24125105)}
...
\HRule \\[0.4cm]
{ 
\huge{\bfseries{STAT452 Final Project}}\\[0.5cm]
\large{\bfseries{Wine Quality and Experimental Design}}
}\\[0.4cm]
\HRule \\[0.5cm]
...
\emph{Tran Le Anh Tuan (24125107) \\ Nguyen Bao Minh  Triet (24125047) \\ Nguyen Hong Tan Tai (24125078) \\ Le Minh Thuan (24125105) \\ Nguyen Dinh Thien Loc (24125093)}\\
...
sensory scores at classes 5 and 6, coupled with the inherent loss of
...
\tightlist
\item
  \textbf{Nguyen Dinh Thien Loc:} project framework and reproducibility
  design; Part 1 data preparation/EDA; Part 2 data audit, design
  justification, and hypotheses.
\item
  \textbf{Tran Le Anh Tuan:} Part 1 cleaning and preprocessing; Part 2
  descriptive statistics and visualizations.
\item
  \textbf{Le Minh Thuan:} Part 1 feature selection and baselines; Part 2
  effect-coded factorial ANOVA and effect sizes.
\item
  \textbf{Nguyen Bao Minh Triet:} Part 1 regularized modelling and
  canonical integration; Part 2 interpretation and report integration.
\item
  \textbf{Nguyen Hong Tan Tai:} Part 1 locked holdout evaluation; Part 2
